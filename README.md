...
- **谁在做**：132 个真实可查的案例，从 Palantir、OpenAI、Anthropic 到 Harvey、Sierra，再到中国的第一批实践者
...
- **整本下载**：[前线部署工程师（FDE）v1.0.12.pdf](前线部署工程师（FDE）v1.0.12.pdf)（根目录合并版；如有更新以章节 Markdown 为准）
